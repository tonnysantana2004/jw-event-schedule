...
<main>
	...
	<section class="jwes-container jwes-event-header">
		...
		<div class="jwes-event-intro">
			...
			<p class="jwes-text jwes-text-1"><?php $excerpt =  get_the_excerpt();
												echo $excerpt ? $excerpt : esc_html("We're now running a handful of different meetup series in spaces around Toronto, from Etobicoke to Scarborough."); ?></p>
			...
			<div class="jwes-info-boxes">
				...
				<div class="jwes-info-box">
					...
					<div class="jwes-info-box-header">
						...
						<h3 class="jwes-title jwes-title-3">Event Date</h3>
				...
				<div class="jwes-info-box">
					...
					<div class="jwes-info-box-header">
						...
						<h3 class="jwes-title jwes-title-3">The location</h3>
	...
	<section class="jwes-container jwes-text jwes-text-1">
		<div class="jwes-content">
			...
			echo $content ? $content : esc_html("We're now running a handful of different meetup series in spaces around Toronto, from Etobicoke to Scarborough.");
